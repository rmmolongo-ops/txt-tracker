...
import { C, TEAM_COLORS, ROLE_CONFIG, KPI_CONFIG, SESSIONS, DEFAULT_PROFIL, DASHBOARD_KPIS_MAX, LEADERSHIP_ROLES, GHOST_PREFIX, isGhostId, ghostRealId, seanceRowKey } from '../lib/constants'
